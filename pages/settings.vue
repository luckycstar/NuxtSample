<template>
  <div class="bg-gray-100">
    <div>
      <div class="relative bg-light-blue-700 pb-32 overflow-hidden">
        <nav
          class="bg-transparent relative z-10 border-b border-blue-500 border-opacity-25 lg:bg-transparent lg:border-none"
          x-state:on="Menu open"
          x-state:off="Menu closed"
          :class="{ 'bg-light-blue-900': open, 'bg-transparent': !open }"
        >
  ...
  Heroicon name: outline/x"
          ...
          <div
            ...
            class="bg-light-blue-900 lg:hidden"
          >
          ...
          <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            >
              <aside class="py-6 lg:col-span-3">
                <nav>
                  <!-- Current: "bg-blue-50 border-blue-500 text-teal-700 hover:bg-blue-50 hover:text-teal-700", Default: "border-transparent text-gray-900 hover:bg-gray-50 hover:text-gray-900" -->
                  <a
                    href="#"
                    class="bg-blue-50 border-blue-500 text-teal-700 hover:bg-blue-50 hover:text-teal-700 group border-l-4 px-3 py-2 flex items-center text-sm font-medium"
                    aria-current="page"
                  >
                      ...
                      <div>
                        ...
                        <div class="mt-1 rounded-md shadow-sm flex">
                          ...
                          <input
                            ...
                            class="focus:ring-light-blue-500 focus:border-blue-500 flex-grow block w-full min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300"
                            value="lisamarie"
                          >
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div class="mt-1">
                          <textarea
                            ...
                            name="about"
                            rows="3"
                            class="shadow-sm focus:ring-light-blue-500 focus:border-blue-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md"
                          />
                        </div>
                  ...
                  <div class="mt-6 grid grid-cols-12 gap-6">
                    <div class="col-span-12 sm:col-span-6">
                      ...
                      <input
                        ...
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-light-blue-500 focus:border-blue-500 sm:text-sm"
                      >
                    </div>
                  ...
                  <div class="px-4 sm:px-6">
                    ...
                    <ul class="mt-2 divide-y divide-gray-200">
                      <li class="py-4 flex items-center justify-between">
                        ...
                        <button
                          type="button"
                          class="bg-gray-200 ml-4 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-blue-500"
                          aria-pressed="true"
                          x-ref="switch"
                          x-state:on="Enabled"
                          x-state:off="Not Enabled"
                          :class="{ 'bg-blue-500': on, 'bg-gray-200': !on }"
